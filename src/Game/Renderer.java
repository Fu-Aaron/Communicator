 ...
 * Date: 11/11/2020
 * Also copied from myself in PhysicsTest package.
 */
public class Renderer {

    public static void draw(Graphics2D g, Drawable shape, double pixelPerMeter) {
        draw(g, shape.getDrawnShape() , pixelPerMeter, shape.getColor());
    }
